      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 20),
            Divider(color: Colors.pink.shade300, thickness: 1),
            const SizedBox(height: 10),
            Card(
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: const Text('15 April 2002'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      leading: const Icon(Icons.web, color: Colors.pink),
                      title: const Text('Website'),
                      subtitle: const Text('hoshizen.com'),
                      onTap: () {},
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      ...
                      subtitle: const Text('alambintang72@gmail.com'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      leading: const Icon(Icons.location_on, color: Colors.pink),
                      title: const Text('Alamat'),
                      subtitle: const Text('jaraksari'),
                    ),
                  ],
                ),
              ),
